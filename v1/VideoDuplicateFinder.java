...
public class VideoDuplicateFinder extends JFrame {
    ...
    public VideoDuplicateFinder() {
        ...
        // --- Table setup ---
        String[] columns = {"Group", "File Name", "Size (MB)", "Full Path"};
        ...
        resultsTable.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 2) {
                    ...
                    if (row >= 0) {
                        String path = (String) resultsTable.getValueAt(row, 3);
                        try {
                    ...
                    for (var entry : sorted) {
                        ...
                        for (File f : entry.getValue()) {
                            tableModel.addRow(new Object[]{
                                group, f.getName(), sizeStr, f.getAbsolutePath()
                            });
                            totalDupes++;
                        }
                        group++;
